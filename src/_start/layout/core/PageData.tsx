...
export interface PageDataContextModel {
  ...
  pageTitleSub?: string;
  setPageTitleSub: (_titlesub: string) => void;
...
const PageDataContext = createContext<PageDataContextModel>({
  ...
  setPageTitleSub: (_titlesub: string) => {},
...
const PageDataProvider: React.FC = ({ children }) => {
  ...
  const [pageTitleSub, setPageTitleSub] = useState<string>("");
...
const PageTitleSub: React.FC = ({ children }) => {
  const { setPageTitleSub } = usePageData();
  useEffect(() => {
    if (children) {
      setPageTitleSub(children.toString());
    }
    return () => {
      setPageTitleSub("");
    };
